                            ...
                            <td>
                                <section>
                                    <div class="custom-switch custom-switch-label-onoff d-flex align-content-center" dir="ltr">
                                        <input data-url="{{ route('admin.setting.province.status', $province->id) }}" onchange="changeStatus(this.id)" class="custom-switch-input" id="{{ $province->id }}" name="status" type="checkbox" @if($province->status) checked @endif>
