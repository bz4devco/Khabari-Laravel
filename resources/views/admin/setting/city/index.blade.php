                            ...
                            <td>
                                <section>
                                    <div class="custom-switch custom-switch-label-onoff d-flex align-content-center" dir="ltr">
                                        <input data-url="{{ route('admin.setting.city.status', $city->id) }}" onchange="changeStatus(this.id)" class="custom-switch-input" id="{{ $city->id }}" name="status" type="checkbox" @if($city->status) checked @endif>
