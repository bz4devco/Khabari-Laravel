                    ...
                    <section class="row">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <section class="row">
                                    <section class="col-md-6 mt-2">
                                        <img src="{{ hasFileUpload($setting->logo ?? null)}}" class="rounded-3" width="100" alt="logo">
                                    </section>
                                </section>
                                @endif
                            </div>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <section class="row">
                                    <section class="col-md-6 mt-2">
                                        <img src="{{ hasFileUpload($setting->icon ?? null)}}" class="rounded-3" width="100" alt="icon">
                                    </section>
                                </section>
                                @endif
                            </div>
                        ...
                        <div class="form-group mb-3">
                                ...
                                <select class="form-select form-select-sm" name="status" id="status">
                                    <option value="0" @if(old('status', $setting->status) == 0)  selected @endif>غیر فعال</option>
                                    <option value="1" @if(old('status', $setting->status) == 1)  selected @endif>فعال</option>
                                </select>
                                @error('status')
                                    <span class="text-danger font-size-12">
                                        <strong>
