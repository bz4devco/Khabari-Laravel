                            ...
                            <div class="form-group mb-3">
                                ...
                                <section>
                                    ...
                                    <div class="custom-switch custom-switch-label-onoff mt-2 d-flex align-content-center" dir="ltr">
                                        <input class="custom-switch-input" id="slider" name="index_page[slider]" type="checkbox" @if($slider) checked @endif>
                        ...
                        <section class="col-12 col-md-3">
                            <div class="form-group mb-3">
                                ...
                                <section>
                                    ...
                                    <div class="custom-switch custom-switch-label-onoff mt-2 d-flex align-content-center" dir="ltr">
                                        <input class="custom-switch-input" id="most_visited_products" name="index_page[mostVisitedProducts]" type="checkbox" @if($mostVisitedProducts) checked @endif>
                        ...
                        <section class="col-12 col-md-3">
                            <div class="form-group mb-3">
                                ...
                                <section>
                                    ...
                                    <div class="custom-switch custom-switch-label-onoff mt-2 d-flex align-content-center" dir="ltr">
                                        <input class="custom-switch-input" id="middle_banners" name="index_page[middleBanners]" type="checkbox" @if($middleBanners) checked @endif>
                        ...
                        <section class="col-12 col-md-3">
                            <div class="form-group mb-3">
                                ...
                                <section>
                                    ...
                                    <div class="custom-switch custom-switch-label-onoff mt-2 d-flex align-content-center" dir="ltr">
                                        <input class="custom-switch-input" id="popular_roducts" name="index_page[popularProducts]" type="checkbox" @if($popularProducts) checked @endif>
                        ...
                        <section class="col-12 col-md-3">
                            <div class="form-group mb-3">
                                ...
                                <section>
                                    ...
                                    <div class="custom-switch custom-switch-label-onoff mt-2 d-flex align-content-center" dir="ltr">
                                        <input class="custom-switch-input" id="four_banners" name="index_page[fourBanners]" type="checkbox" @if($fourBanners) checked @endif>
                        ...
                        <section class="col-12 col-md-3">
                            <div class="form-group mb-3">
                                ...
                                <section>
                                    ...
                                    <div class="custom-switch custom-switch-label-onoff mt-2 d-flex align-content-center" dir="ltr">
                                        <input class="custom-switch-input" id="offer_products" name="index_page[offerProducts]" type="checkbox" @if($offerProducts) checked @endif>
                        ...
                        <section class="col-12 col-md-3">
                            <div class="form-group mb-3">
                                ...
                                <section>
                                    ...
                                    <div class="custom-switch custom-switch-label-onoff mt-2 d-flex align-content-center" dir="ltr">
                                        <input class="custom-switch-input" id="bottom_banner" name="index_page[bottomBanner]" type="checkbox" @if($bottomBanner) checked @endif>
                        ...
                        <section class="col-12 col-md-3">
                            <div class="form-group mb-3">
                                ...
                                <section>
                                    ...
                                    <div class="custom-switch custom-switch-label-onoff mt-2 d-flex align-content-center" dir="ltr">
                                        <input class="custom-switch-input" id="brands" name="index_page[brands]" type="checkbox" @if($brands) checked @endif>
