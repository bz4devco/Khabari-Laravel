...
@section('haed-tag')
<title> ویرایش پیج | پنل مدیریت</title>
@endsection
...
<section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="">
                <form id="form" action="{{ route('admin.content.page.update', $page->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <section class="row">
                        <section class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input id="title" name="title" class="form-control form-select-sm" type="text" value="{{ old('title', $page->title) }}">
                                @error('title')
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input id="url" class="form-control form-select-sm disabled" readonly type="text" value="{{$page->slug}}">
                            </div>
                        </section>
                        <section class="col-12 mb-3">
                            <div class="form-group">
                                <label for="body">محتوی</label>
                                <textarea id="body" name="body">{{ old('body', $page->body) }}</textarea>
                                @error('body')
                                <span class="text-danger font-size-12">
                                    <strong>
                                        {{ $message }}
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control form-select-sm d-none" type="text" name="tags" id="tags" value="{{ old('tags', $page->tags) }}">
