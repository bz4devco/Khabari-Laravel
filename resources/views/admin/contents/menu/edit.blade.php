                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select form-select-sm" name="position" id="position">
                                    ...
                                    <option value="{{$key}}" @if(old('position', $menu->position) == $key) selected @endif>{{ $position }}</option>
                                    @empty
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select form-select-sm" name="status" id="status">
                                    <option value="0" @if(old('status', $menu->status)==0) >غیر فعال</option>
                                    <option value="1" @if(old('status', $menu->status)==1) >فعال</option>
                                </select>
                                @error('status')
                                <span class="text-danger font-size-12">
                                    <strong>
