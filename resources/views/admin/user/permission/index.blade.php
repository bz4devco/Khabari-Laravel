                            ...
                            <td>
                                <section>
                                    <div class="custom-switch custom-switch-label-onoff d-flex align-content-center" dir="ltr">
                                        <input data-url="{{ route('admin.user.permission.status', $permission->id) }}" onchange="changeStatus(this.id)" class="custom-switch-input" id="{{ $permission->id }}" name="status" type="checkbox" @if($permission->status) checked @endif>
