                            ...
                            <td>
                                <section>
                                    <div class="custom-switch custom-switch-label-onoff d-flex align-content-center" dir="ltr">
                                        <input data-url="{{ route('admin.user.admin-user.status', $admin->id) }}" onchange="changeStatus(this.id)" class="custom-switch-input" id="status-{{ $admin->id }}" name="status" type="checkbox" @if($admin->status) checked @endif>
