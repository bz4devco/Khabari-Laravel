...
@section('haed-tag')
<title> ویرایش ادمین | پنل مدیریت</title>
@endsection
...
<section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="">
                <form id="form" action="{{ route('admin.user.admin-user.update', $admin->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <section class="row">
                        <section class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control form-select-sm" type="text" name="first_name" id="first_name" value="{{old('first_name', $admin->first_name)}}">
                                @error('first_name')
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control form-select-sm" type="text" name="last_name" id="last_name" value="{{old('last_name', $admin->last_name)}}">
                                @error('last_name')
                                    <span class="text-danger font-size-12">
                                        <strong>
                                            {{ $message }}
                            ...
                            <div class="form-group mb-3">
                                ...
                                <section class="row">
                                    <section class="col-md-6 mt-2">
                                        <img src="{{ hasFileUpload($admin->profile_photo_path)}}" class="rounded-3" width="100" alt="avatar">
                                    </section>
                                </section>
                                @endif
                            </div>
