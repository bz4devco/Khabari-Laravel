...
<ol class="breadcrumb m-0 font-size-12">
    ...
    <li class="breadcrumb-item deco"><a class="text-decoration-none" href="{{ route('admin.user.user.index') }}">کاربران</a></li>
    ...
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center mt-4 pb-3 mb-3 border-bottom">
                <a href="{{ route('admin.user.user.index') }}" class="btn btn-sm btn-info text-white">بازگشت</a>
            </section>
            <section class="">
                <form id="form" action="{{ route('admin.user.user.update', $user->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <section class="row">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <section class="row">
                                    <section class="col-md-6 mt-2">
                                        <img src="{{ hasFileUpload($user->profile_photo_path)}}" class="rounded-3" width="100" alt="avatar">
                                    </section>
                                </section>
                                @endif
                            </div>
