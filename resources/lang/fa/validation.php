...
return [
    ...
    */
    ...
    ""           => ":attribute انتخاب شده، معتبر نیست.",
    ...
    'lt' => [
        'numeric' => ':attribute نمیتواند کوچک تر از تاریخ پایان باشد',
    ],
    'gt' => [
        'numeric' => ':attribute نمیتواند بزرگ تر از تاریخ شروع باشد',
    ],
    ...
    */
    'attributes' => [
        ...
        "service_status"            => "وضعیت نظام وظیفه", 
        "captcha"                   => "کد امنیتی", 
        "new_date"                 => "تاریخ انتشار خبر", 
    ],
];
